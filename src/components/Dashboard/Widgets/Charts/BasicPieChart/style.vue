  ...
  <div>
    <div v-show="tab === 1">
      ...
      <div class="panel-item-new">
        <div @click="isShowBarItem = !isShowBarItem" class="panel-item-title">图表设置<i :class="isShowBarItem ? 'el-icon-caret-bottom' : 'el-icon-caret-right'" class="panel-title-arrow"></i></div>
...
export default {
  name: 'PieRoseStyle',
  typeStyles: ['PieBasic', 'PieRose'], // 同一套组件代码分为不同的组件需添加该属性，用于右侧面板panel的显示
  components: {
    DataSettings,
    BasicSettings,
    CommonSettings
