<template>
  <div>
    <div v-show="tab === 1">
      ...
      <div class="panel-item-new">
        ...
        <div v-show="isShowLine" class="panel-item-new-set">
          ...
          <div v-show="activeElement.turnStack && activeElement.type === 'BarsUp'" class="panel-row" flex>
            <div class="panel-label">显示数值</div>
            <div class="panel-value">
              <label class="form-switch">
                <input
                  v-model="activeElement.turnShowLabel"
                  type="checkbox" >
                <i class="form-icon"/>
              </label>
            </div>
    ...
    <div v-show="tab === 3">
      ...
      <div class="panel-item-new" style="display: none">
        <div @click="isShowStack = !isShowStack" class="panel-item-title">条形堆叠图<i :class="isShowStack ? 'el-icon-caret-bottom' : 'el-icon-caret-right'" class="panel-title-arrow"></i></div>
        <div v-show="isShowStack" class="panel-item-new-set">
          <div
            class="panel-row"
            flex>
            <div class="panel-label">转为堆叠图</div>
            <div class="panel-value">
              <label class="form-switch">
                <input
                  v-model="activeElement.turnStack"
                  type="checkbox" >
                <i class="form-icon"/>
              </label>
            </div>
          </div>
          <div v-show="activeElement.turnStack" class="panel-row" flex>
            <div class="panel-label">显示数值</div>
            <div class="panel-value">
              <label class="form-switch">
                <input
